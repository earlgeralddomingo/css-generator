...
<template>
    ...
    >
        <section class="mx-auto max-w-7xl">
            ...
            <div
                class="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]"
            >
                <aside
                    ...
                    <div class="p-5">
                        <div v-if="activePanel === 'layout'">
                            ...
                            <div class="space-y-5">
                                <div>
                                    <div
                                        class="mb-3 text-xs font-semibold text-slate-700 dark:text-slate-300"
                                    >
                                        Grid Size
                                    </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="w-8 text-center font-mono text-sm font-semibold"
                                                >
                                                    {{ columns }}
                                                </span>
                                ...
                                >
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p
                                                class="mt-0.5 font-mono text-xs text-[#1769B0] dark:text-cyan-300"
                                            >
                                                {{ selectedArea }}
                                            </p>
                                        </div>
                                    ...
                                    <label class="block">
                                        <span
                                            class="mb-2 block text-xs text-slate-500"
                                        >
                                            Area Name
                                        </span>
                                ...
                                <label class="block">
                                    <span
                                        class="mb-2 block text-xs font-medium text-slate-600 dark:text-slate-400"
                                    >
                                        Grid Auto Flow
                                    </span>
...
.main {
    line-height: 1.6;
                                ...
                                class="min-h-[380px] w-full resize-y rounded-xl border border-slate-200 bg-[#050B14] p-4 font-mono text-xs leading-6 text-slate-300 outline-none transition focus:border-cyan-500 dark:border-slate-700"
                            ></textarea>
                        </div>
                        ...
                        <div v-else-if="activePanel === 'import'">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <textarea
                                        v-model="importedHTML"
                                        spellcheck="false"
                                        placeholder='<header class="header">
    Header
</header>
...
<footer class="footer">
    Footer
                                        ...
                                        class="min-h-[260px] w-full resize-y rounded-xl border border-slate-200 bg-[#050B14] p-4 font-mono text-xs leading-6 text-slate-300 outline-none transition focus:border-cyan-500 dark:border-slate-700"
                                    ></textarea>
                                </div>
...
.main {
    padding: 24px;
                                        ...
                                        class="min-h-[220px] w-full resize-y rounded-xl border border-slate-200 bg-[#050B14] p-4 font-mono text-xs leading-6 text-slate-300 outline-none transition focus:border-cyan-500 dark:border-slate-700"
                                    ></textarea>
                                </div>
                                ...
                                <button
                                    v-if="useImportedContent"
                                    type="button"
                                    @click="useGeneratedGrid"
                                ...
                                >
                                    ...
                                    <ul
                                        class="mt-2 space-y-1.5 text-xs leading-5 text-slate-500 dark:text-slate-400"
                                    >
                                        <li>
                ...
                >
                    ...
                    <div
                        class="flex flex-1 flex-col overflow-auto bg-slate-50 p-6 dark:bg-[#050B14] sm:p-10"
                    >
                        <div
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p
                                    class="mt-1 leading-5 text-[#1769B0]/80 dark:text-cyan-300/70"
                                >
                                    {{
                                        selectedArea
                        ...
                        >
                            <div
                                class="min-h-[440px] w-full preview-grid"
                                :style="previewStyle"
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="contents preview-import-scope"
                                        v-html="
                                            importedHTMLProcessed
                                        "
                                    ></div>
    ...
    {{ gridTemplateAreasValue }};</code></pre>
                        ...
                        >
                            ...
                            <span
                                class="rounded-md bg-[#123B7A] px-2 py-1 font-mono font-semibold text-white"
                            >
                                {{ columns }} columns
                            </span>

                            <span
                                class="rounded-md bg-[#1769B0] px-2 py-1 font-mono font-semibold text-white"
                            >
                                {{ rows }} rows
                            </span>
                            ...
                            <span
                                class="font-mono text-[#1769B0] dark:text-cyan-300"
                            >
            ...
            >
                ...
                >
                    <div>
                        ...
                        >
                            <span
                                class="size-1.5 rounded-full bg-[#7BD957] shadow shadow-[#7BD957]"
                            ></span>
                        ...
                        <p
                            class="mt-1 max-w-xl text-sm leading-6 text-cyan-50/80"
                        >
