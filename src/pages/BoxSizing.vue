...
const boxSizingOptions = [
    {
        value: 'content-box',
        label: 'content-box',
        description: 'Width and height apply to content only.',
    },
    {
        value: 'border-box',
        label: 'border-box',
        description: 'Width and height include padding and border.',
    },
]
...
const previewStyle = computed(() => ({
    ...
    padding: `${settings.value.padding}px`,
    borderWidth: `${settings.value.borderWidth}px`,
    borderStyle: settings.value.borderStyle,
    borderColor: settings.value.borderColor,
    borderRadius: `${settings.value.borderRadius}px`,
    boxSizing: settings.value.boxSizing,
...
const generatedHtml = computed(() => {
    return `<div class="box-sizing-element">
...
<head>
    ...
    <title>CSSCraft Box Sizing</title>
...
const boxDescription = computed(() => {
    const option = boxSizingOptions.find(
        item => item.value === settings.value.boxSizing
    )
...
const exportHtml = () => {
    ...
    link.href = url
    link.download = 'box-sizing-generator.html'
                ...
                <div
                    ...
                    <div>
                        ...
                        <p
                            ...
                            Configure box sizing, dimensions, padding, borders
                            and radius while generating clean CSS instantly.
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button
                            type="button"
                            @click="reset"
                            class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-750">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="3"
                                class="w-full resize-none rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-700 outline-none transition focus:border-cyan-400 focus:ring-2 focus:ring-cyan-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500 dark:focus:border-cyan-500 dark:focus:ring-cyan-950"
                        ...
                        <div class="mt-5">
                            ...
                            <select
                                ...
                                <option
                                    v-for="option in boxSizingOptions"
                                    :key="option.value"
                                    :value="option.value">
                            ...
                            <p
                                class="mt-2 text-[10px] leading-4 text-slate-400 dark:text-gray-500">
                    ...
                    <section
                        ...
                        <div
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p
                                            ...
                                            Change the sizing controls to see the
                                            box model update instantly.
                            ...
                            <div
                                ...
                                <div
                                    class="flex min-h-[430px] items-center justify-center overflow-auto rounded-lg border border-slate-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-950 sm:p-12">

                                    <div
                                        class="flex shrink-0 items-center justify-center break-words text-center font-semibold text-[#10233f] transition-all duration-200 dark:text-gray-900"
                                        :style="previewStyle">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p
                                        ...
                                        CSS generated from your box settings.
